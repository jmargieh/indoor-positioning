...
function init() {
    ...
    var multiCoords1 = [
        [{"coord" : [[47.5468, -0.7910],[48.8068, -0.1318]], "rate" : 1 }, {"coord" : [[48.8068, -0.1318],[49.4966, 3.2958]],"rate" : 2 }, {"coord": [[49.4966, 3.2958],[51.7542, 2.1093]], "rate" : 3 }, {"coord": [[51.7542, 2.1093],[53.7542, 2.8693]], "rate" : 4 }]
        //[[51.7542, 2.1093],[49.4966, 3.2958],[49.4966, 3.2958],[48.8068, -0.1318],[48.8068, -0.1318],[47.5468, -0.7910]],
    ...
    for(var i=0; i<multiCoords1[0].length; i++) {
        plArray.push(L.polyline(multiCoords1[0][i].coord,{weight: multiCoords1[0][i].rate , opacity:1}).addTo(map));
    }
